...
public class EditTimesheetSuccessTest extends BaseTest{
	...
	public void editTimesheetSuccessTest(String username, String password, String project, String monday, String tuesday, String wednesday, String thursday, String friday, String saturday, String sunday ){
		login = new LoginPage();
